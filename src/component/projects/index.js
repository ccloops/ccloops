...
export default class Projects extends React.Component {
  render() {
    ...
    // let {project, handleProjectClick} = this.props;

    // let showModal = () => handleProjectClick({...viewing, clicked: true});
    let showModal = () => console.log('show modal');
    // let hideModal = () => handleProjectClick({...viewing, clicked: false});

    // let projectClose = (project) => {
    //   handleProjectClick({...viewing, clicked: false});
    // };

    return (
      <div className='projects'>
        <img onDoubleClick={showModal} src={Clouds} alt='cloud-level' />
        ...
        <img onDoubleClick={showModal} src={Quiz} alt='quiz fellows'/>
        ...
        <img onDoubleClick={showModal} src={OhRose} alt='Oh, Rose' />
        <p>A React application for a band from Olympia, Washington.</p>
        <h3>Oh, Rose</h3>

   
        <img onDoubleClick={showModal} src={Trendly} alt='Trendly'/>
        ...
        <img onDoubleClick={showModal} src={Todo} alt='Todo List'/>
...
// <Modal handleClose={hideModal} show={project.viewing}>
